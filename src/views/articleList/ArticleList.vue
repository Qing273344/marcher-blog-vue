...
<script lang="ts">
  ...
  export default class ArticleList extends Vue {
    ...
    private handleLiked(article: ArticleListBean) {
      ...
      ArticleApi.liked({id: articleId}).then((data: any) => {
        article.likedCount = data;
      });
    }
     ...
     */
    private query() {
      ArticleApi.query(this.queryData).then((responseBean: any) => {
        this.articleListBeanList = responseBean.data.list;
        this.pageUtil = responseBean.page;
        this.pageUtil.pageStyle = PageStyleEnum.SIMPLE_LAYOUT;
      });
    }
